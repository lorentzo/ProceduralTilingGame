...
public class Tiling : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 PlayerCo = new Vector3(Player.transform.position.x, 0, Player.transform.position.z);
    ...
    void animateWorldProps()
    {
        ...
        {
            float movementY = -4.0f * Time.deltaTime; // Maybe scaling?
    ...
    void animateWorldBlocks()
    {
        ...
        {
            float movementY = 4.0f * Time.deltaTime;
